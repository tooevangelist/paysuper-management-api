...
require (
	...
	github.com/paysuper/paysuper-billing-server v0.0.0-20190701160214-119c4e2eb031
	github.com/paysuper/paysuper-currencies v0.0.0-20190703112408-447ce8c766da
