...
const (
    ...
    errorNamespaceMerchantBankingCurrency             = "MerchantBanking.Currency"
    errorNamespaceMerchantBankingName                 = "MerchantBanking.Name"
    errorNamespaceMerchantBankingAddress              = "MerchantBanking.Address"
    errorNamespaceMerchantBankingAccountNumber        = "MerchantBanking.AccountNumber"
    errorNamespaceMerchantBankingSwift                = "MerchantBanking.Swift"
    errorNamespaceMerchantBankingCorrespondentAccount = "MerchantBanking.CorrespondentAccount"
)
