...
var (
	...
	errorMessageMerchantNotFound                      = newManagementApiResponseError("ma000097", "merchant not found")
	errorMessageCreateReportFile                      = newManagementApiResponseError("ma000098", "unable to create report file")
	errorMessageDownloadReportFile                    = newManagementApiResponseError("ma000099", "unable to download report file")
